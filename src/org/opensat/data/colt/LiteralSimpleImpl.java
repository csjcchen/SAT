 ...
 *
 */
class LiteralSimpleImpl implements ILiteral, Comparable {
    ...
    protected LiteralSimpleImpl(int id) {
        ...
        listadapter = new ObjectListAdapter(clauses);
    }
    ...
    /**
     * @see org.opensat.ILiteral#register(IClause)
     */
    public void watch(IClause cl) {
        assert cl.contains(this);
        assert !clauses.contains(cl, false);
        clauses.add(cl);
    }

    /**
     * @see org.opensat.ILiteral#unregister(IClause)
     */
    public void hide(IClause cl) {
        assert clauses.contains(cl, false);
        int i = clauses.indexOf(cl,false);
        assert i != -1;
        clauses.remove(i);
    }
    ...
    */
    ...
    private final ObjectArrayList clauses;
